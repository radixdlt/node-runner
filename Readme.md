...
To dowload the cli, following instructions from [here](https://docs.radixdlt.com/main/radix-nodes/running-a-docker-node-with-radixnode.html#_download_the_radixnode_script)
